...
public class Smartdashboard  extends Subsystem {
  ...
  // Robot
  public void SmartDashboardInitialize() {
  ...
  public void updateSmartdashboard() {
    ...
    SmartDashboard.putNumber("limelightX", Robot.Limelight.limelightX());
    SmartDashboard.putNumber("limelightY", Robot.Limelight.limelightY());
    SmartDashboard.putNumber("limelightArea", Robot.Limelight.limelightArea());
  }

  public void pullFromSmartdashboard() {
